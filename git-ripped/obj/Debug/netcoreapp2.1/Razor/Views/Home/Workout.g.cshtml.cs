#pragma checksum "D:\jmwen\repos\Capstone\Capstone\git-ripped\Views\Home\Workout.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e2029c3206900b463d6d9253cc1405054ed16219"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e2029c3206900b463d6d9253cc1405054ed16219", @"/Views/Home/Workout.cshtml")]
...
#line hidden
	...
	<ul class=""nav nav-tabs"" id=""workoutTabs"" role=""tablist"">
		<li ng-repeat=""lift in workout.Lifts"" class=""nav-item"">
			<a class=""nav-link"" aria-selected=""{{$index==0}}"" id=""{{lift.LiftID}}"" data-toggle=""tab"" href=""#lift{{$index}}"" role=""tab"" aria-controls=""lift{{$index}}"">
				{{lift.LiftName}}
			</a>
			
		</li>
		<li class=""nav-item"">
			<a class=""nav-link active"" data-toggle=""tab"" href=""#liftList"" role=""tab"" aria-controls=""liftList"" >
	...
	<div class=""tab-content"" id=""myTabContent"" ng-cloak>
		<div ng-repeat=""lift in workout.Lifts"" class=""mx-3 tab-pane fade"" id=""lift{{$index}}"" role=""tabpanel"" aria-labelledby=""lift{{$index}}"">
			");
            EndContext();
            BeginContext(880, 646, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2129543722704ad7a25bde4ea159618a", async() => {
                BeginContext(886, 633, true);
                WriteLiteral(@"
				<div class=""md-form row ml-1"" ng-repeat=""set in lift.SetList"">
					<div class=""col-3 px-0"">
						<input type=""number"" id=""weight{{lift.LiftNameID}}:{{set.SetID}}"" ng-model=""set.Weight"" class=""form-control"" />
					...
					<div class=""col-3 px-0"">
						<input type=""number"" id=""reps{{lift.LiftNameID}}:{{set.SetID}}"" ng-model=""set.Repetitions"" class=""form-control"" />
		...
		<div class=""mx-3 tab-pane fade show active"" id=""liftList"" role=""tabpanel"" aria-labelledby=""liftList"">
			<ul>
